...
The backend provides several API routes for managing accounts, authentication, and user details. The detailed information about these routes is in the backend's [README file](./backend/Readme.md).
